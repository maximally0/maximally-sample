      ...
      <div className="maximally-container">
        <div className="max-w-3xl mx-auto">
          <div className="prose prose-lg max-w-none">
            <p className="text-xl font-medium mb-10 text-gray-700 leading-relaxed text-balance">
              {post.excerpt}
            </p>
            ...
            {post.category === "Gut Health" && (
              <>
                <h2 className="text-2xl md:text-3xl font-bold mb-6 text-maximally-900">The Importance of Gut Health</h2>
                <p className="mb-6">
                ...
                <div className="my-8 p-6 bg-[#F8FDFE] border-l-4 border-[#00E5FF] rounded-r-lg">
                  <p className="mb-4">
                    The <a href="https://www.nature.com/articles/s41575-020-0269-9" target="_blank" rel="noopener noreferrer" className="text-[#00E5FF] hover:underline inline-flex items-center font-medium">Human Microbiome Project <ExternalLink className="ml-1 w-3 h-3" /></a> has been instrumental in helping us understand these complex relationships. When the balance of microbes in your gut becomes disrupted, a condition known as dysbiosis, it can lead to various health issues.
                  </p>
                </div>
                
                <h3 className="text-xl font-bold mb-4 text-maximally-800">Common Issues Related to Gut Dysbiosis:</h3>
                <ul className="space-y-2 mb-8">
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 mt-2 mr-2 bg-[#00E5FF] rounded-full"></span>
                    <span>Digestive problems (bloating, gas, diarrhea)</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 mt-2 mr-2 bg-[#00E5FF] rounded-full"></span>
                    <span>Weakened immune response</span>
                  </li>
                  <li className="flex items-start">
                    <span className="inline-block w-2 h-2 mt-2 mr-2 bg-[#00E5FF] rounded-full"></span>
            ...
            <div className="my-10 p-6 bg-gradient-to-r from-[#E0F7FA] to-[#F3F3F3] rounded-lg">
              <h2 className="text-2xl font-bold mb-4 text-maximally-900">Maximally's Approach to Probiotics</h2>
              <p className="mb-4">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <h3 className="font-medium text-xl mb-5">Share this article</h3>
