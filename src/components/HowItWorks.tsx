...
const Step = ({
  ...
  return <div ref={stepRef} className="reveal-on-scroll flex flex-col md:flex-row items-start gap-4 md:gap-6">
...
const HowItWorks = () => {
  ...
  return <section id="how-it-works" className="section-padding bg-[#F9FAFB]" ref={sectionRef}>
      <div className="maximally-container">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Image Section */}
          <div className="order-2 lg:order-1">
            <div className="relative">
              <img alt="Probiotic Science" className="rounded-xl shadow-lg animate-float max-w-full h-auto sharp-border" src="https://media.istockphoto.com/id/1328764378/vector/happy-kawaii-character-of-small-and-large-intestine-human-body-internal-organ-of-the.jpg?s=612x612&w=0&k=20&c=EMuVzu47R2vVCKhEtBKHx-M5Q-9cNmcXmjSaS2JjrhQ=" />
          ...
          <div className="order-1 lg:order-2">
            ...
            <div className="space-y-10 mb-10">
              {steps.map((step, index) => <Step key={index} number={step.number} title={step.title} description={step.description} delay={step.delay} />)}
            </div>
            ...
            {/* CTA */}
            <div className="mt-8">
              <CTAButton text="Experience the Transparent Difference" href="/formulation" variant="primary" size="lg" withArrow />
            </div>
          </div>
        </div>
      </div>
